# Historischer NetWatch-Entwurf

> Archivierter Ausgangsplan. Nicht der aktuelle Runtime-Stand und keine
> operative Source of Truth. Der aktuelle Stand steht in
> `00_infos/llm-context.md`; die fachliche Gegenpruefung in
> `TECHNICAL_AUDIT.md`.
